      ...
      <table class="min-w-full">
        <thead>
          <tr class="border-b border-gray-200 dark:border-gray-700">            
            ...
            <th class="px-5 py-3 text-left w-2/11 sm:px-6">
              <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Project Proposal</p>
            </th>
          </tr>
        </thead>
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          >            
            <td class="px-5 py-4 sm:px-6">
              <a href="#" class="text-gray-500 text-theme-sm dark:text-gray-400">{{ user.project }}</a>
            </td>
            <td class="px-5 py-4 sm:px-6">
            ...
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ user.proposal }}</p>
            </td>
          </tr>
        </tbody>
      </table>
