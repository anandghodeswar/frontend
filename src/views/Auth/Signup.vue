  ...
  <FullScreenLayout>
    ...
    <div>
      <label
        ...
        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
      >
        Mobile Number<span class="text-error-500">*</span>
      </label>
      <input
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <router-link to="/" class="block mb-4">
                <img width="{231}" height="{48}" src="/images/logo/MPA_Logo_2.png" alt="Logo" />
              </router-link>
...
const handleSubmit = async () => {
  ...
  if (!agreeToTerms.value) {
    errorMessage.value = 'Please accept Terms and Conditions'
    return
  }
  ...
  try {
    ...
    const response = await axios.post(
      'http://localhost:5000/api/auth/register', payload, {
